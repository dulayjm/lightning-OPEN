...
class Model(LightningModule):
    ...
    def validation_step(self, batch, batch_idx):
        ...
        # print("validation accuracy in batch", val_acc)
        # print("\n\n\n\nHERE\n\n\n\n")
        
        # if batch_idx == 0:
        #     self.training_correct_counter = (torch.max(outputs, 1)[1].view(labels.size()) == labels).sum()
        # else:
        #     self.training_correct_counter += (torch.max(outputs, 1)[1].view(labels.size()) == labels).sum()
    ...
    def validation_epoch_end(self, validation_step_outputs):
        ...
        # val_acc = 100 * self.training_correct_counter / len(self.validset)
        print("val_acc", val_acc)
        print("\n\n\nHERE\n\n\n")
